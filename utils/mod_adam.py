...
class ModAdam(Optimizer):
    ...
    def step(self, closure=None, update_factor_dict: dict[int, Tensor] = {}):
        ...
        for group in self.param_groups:
            ...
            adam(
                ...
                update_factor_dict=update_factor_dict
            )
...
def adam(params: List[Tensor],
         ...
         *,
         ...
         update_projection_dict: dict[int, Tensor],
         arg_dict: dict[str, Any],
         update_factor_dict: dict[int, Tensor] = {}
         ):
